...
try:
    from alpha.environment.mincraft_env.mincraft_env import MincraftExtEnv  # noqa: F401
except Exception:
    # Optional dependency (e.g., langchain). Ignore if not needed.
    MincraftExtEnv = None  # type: ignore

...
PROPERTY_VOCABULARY = (
    ...
    ("flexural_modulus", "弯曲模量", ("弯曲模量", "抗弯模量"), r"GPa", "GPa"),
    ...
    ("longitudinal_tensile_modulus", "纵向拉伸模量", ("纵向拉伸模量", "0°拉伸模量"), r"GPa", "GPa"),
    ("longitudinal_tensile_strength", "纵向拉伸强度", ("纵向拉伸强度", "0°拉伸强度"), r"MPa", "MPa"),
    ("in_plane_shear_modulus", "面内剪切模量", ("面内剪切模量",), r"GPa", "GPa"),
    ("z_axis_youngs_modulus", "Z 向杨氏模量", ("Z向杨氏模量",), r"GPa", "GPa"),
    ("z_axis_tensile_strength", "Z 向拉伸强度", ("Z向拉伸强度",), r"MPa", "MPa"),
    ("shear_modulus", "剪切模量", ("剪切模量", "G模量"), r"GPa", "GPa"),
    ("hardness", "硬度", ("硬度", "维氏硬度", "洛氏硬度", "布氏硬度"), r"(?:HV|HBW?|HRC|HRB)", ""),
    ("elongation", "延伸率", ("延伸率", "断裂伸长率", "断裂延伸率"), r"%", "%"),
    ("izod_impact_strength_notched", "缺口 Izod 冲击强度", ("缺口Izod冲击强度", "Izod冲击强度"), r"J\s*/\s*m", "J/m"),
    ...
    ("low_cycle_fatigue_life", "低周疲劳寿命", ("低周疲劳寿命", "低周疲劳", "LCF寿命"), r"(?:cycles|次)", "cycles"),
